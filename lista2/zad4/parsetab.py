...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','test.py',68),
  ('statement -> expression','statement',1,'p_statement_expr','test.py',73),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','test.py',78),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','test.py',79),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','test.py',80),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','test.py',81),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','test.py',93),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','test.py',99),
  ('expression -> NUMBER','expression',1,'p_expression_number','test.py',104),
  ('expression -> NAME','expression',1,'p_expression_name','test.py',109),
]
