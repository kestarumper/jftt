...
_lr_signature = 'ASSIGN COLON DECLARE DIVIDE DO DOWNTO ELSE END ENDDO ENDFOR ENDIF ENDWHILE EQ FOR FROM GEQ GT IF IN LEQ LPAREN LT MINUS MODULO NEQ PLUS READ RPAREN SEMI THEN TIMES TO WHILE WRITE num pidentifierprogram      : DECLARE declarations IN commands ENDdeclarations : declarations pidentifier SEMIdeclarations : declarations pidentifier LPAREN num COLON num RPAREN SEMIdeclarations : commands  : commands commandcommands  : commandcommand  : identifier ASSIGN expression SEMIcommand  : IF condition THEN commands ELSE commands ENDIFcommand  : IF condition THEN commands ENDIFcommand  : WHILE condition DO commands ENDWHILEcommand  : DO commands WHILE condition ENDDOcommand  : FOR pidentifier FROM value TO value DO commands ENDFORcommand  : FOR pidentifier FROM value DOWNTO value DO commands ENDFORcommand  : READ identifier SEMIcommand  : WRITE value SEMIexpression   : valueexpression   : value PLUS value\n                    | value MINUS value\n                    | value TIMES value\n                    | value DIVIDE value\n                    | value MODULO valuecondition    : value EQ value\n                    | value NEQ value\n                    | value LT value\n                    | value GT value\n                    | value LEQ value\n                    | value GEQ valuevalue    : identifiervalue    : numidentifier   : pidentifieridentifier   : pidentifier LPAREN pidentifier RPARENidentifier   : pidentifier LPAREN num RPAREN'
...
_lr_productions = [
  ...
  ('program -> DECLARE declarations IN commands END','program',5,'p_program','parser.py',20),
  ('declarations -> declarations pidentifier SEMI','declarations',3,'p_declarations_VARIABLE','parser.py',25),
  ('declarations -> declarations pidentifier LPAREN num COLON num RPAREN SEMI','declarations',8,'p_declarations_ARRAY','parser.py',31),
  ('declarations -> <empty>','declarations',0,'p_declarations_EMPTY','parser.py',40),
  ('commands -> commands command','commands',2,'p_commands_append','parser.py',44),
  ('commands -> command','commands',1,'p_commands','parser.py',49),
  ('command -> identifier ASSIGN expression SEMI','command',4,'p_command_ASSIGN','parser.py',54),
  ('command -> IF condition THEN commands ELSE commands ENDIF','command',7,'p_command_IFTHENELSE','parser.py',59),
  ('command -> IF condition THEN commands ENDIF','command',5,'p_command_IFTHEN','parser.py',64),
  ('command -> WHILE condition DO commands ENDWHILE','command',5,'p_command_WHILE','parser.py',69),
  ('command -> DO commands WHILE condition ENDDO','command',5,'p_command_DOWHILE','parser.py',74),
  ('command -> FOR pidentifier FROM value TO value DO commands ENDFOR','command',9,'p_command_FOR','parser.py',79),
  ('command -> FOR pidentifier FROM value DOWNTO value DO commands ENDFOR','command',9,'p_command_FORDOWNTO','parser.py',84),
  ('command -> READ identifier SEMI','command',3,'p_command_READ','parser.py',89),
  ('command -> WRITE value SEMI','command',3,'p_command_WRITE','parser.py',94),
  ('expression -> value','expression',1,'p_expression_value','parser.py',99),
  ('expression -> value PLUS value','expression',3,'p_expression','parser.py',104),
  ('expression -> value MINUS value','expression',3,'p_expression','parser.py',105),
  ('expression -> value TIMES value','expression',3,'p_expression','parser.py',106),
  ('expression -> value DIVIDE value','expression',3,'p_expression','parser.py',107),
  ('expression -> value MODULO value','expression',3,'p_expression','parser.py',108),
  ('condition -> value EQ value','condition',3,'p_condition','parser.py',113),
  ('condition -> value NEQ value','condition',3,'p_condition','parser.py',114),
  ('condition -> value LT value','condition',3,'p_condition','parser.py',115),
  ('condition -> value GT value','condition',3,'p_condition','parser.py',116),
  ('condition -> value LEQ value','condition',3,'p_condition','parser.py',117),
  ('condition -> value GEQ value','condition',3,'p_condition','parser.py',118),
  ('value -> identifier','value',1,'p_value_identifier','parser.py',123),
  ('value -> num','value',1,'p_value_num','parser.py',128),
  ('identifier -> pidentifier','identifier',1,'p_identifier','parser.py',133),
  ('identifier -> pidentifier LPAREN pidentifier RPAREN','identifier',4,'p_identifier_arrayAccess_pidentifier','parser.py',138),
  ('identifier -> pidentifier LPAREN num RPAREN','identifier',4,'p_identifier_arrayAccess_num','parser.py',143),
]
